import svgPaths from "./svg-p6zgkyb6y1";

function Container() {
  return <div className="absolute bg-[#dab2ff] blur-[64px] left-[10.74px] opacity-30 rounded-[22369600px] size-[422.191px] top-[-68.82px]" data-name="Container" />;
}

function Container1() {
  return <div className="absolute bg-[#fda5d5] blur-[64px] h-[384.811px] left-[554.23px] opacity-30 rounded-[22369600px] top-[-1.46px] w-[384.81px]" data-name="Container" />;
}
...
function Container22() {
  return <div className="absolute bg-[#c27aff] left-[-9.89px] opacity-50 rounded-[22369600px] size-[79.781px] top-[-9.89px]" data-name="Container" />;
}
