import svgPaths from "./svg-5xbun72ywn";
...
function SelfDriveScreen1() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.7)] content-stretch flex flex-col h-[85.333px] items-start left-[265px] pb-[0.667px] pt-[12.667px] px-[16.667px] rounded-[28px] top-[702px] w-[408px]" data-name="SelfDriveScreen">
